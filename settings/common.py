"""Django settings for openhouce project.
...
APPS_DIR = ROOT_DIR.path("openhouce")
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    "DEFAULT_PAGINATION_CLASS": "openhouce.base.api.pagination.PageNumberPagination",
    "PAGE_SIZE": 30,

    # Default renderer classes for Rest framework
    "DEFAULT_RENDERER_CLASSES": [
        "openhouce.base.renderers.OpenhouceApiRenderer",
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "openhouce.users.auth.backends.UserTokenAuthentication",
        # Mainly used for api debug.
        "rest_framework.authentication.SessionAuthentication",
    ),
    "DEFAULT_SCHEMA_CLASS": 'rest_framework.schemas.coreapi.AutoSchema',
    "EXCEPTION_HANDLER": "openhouce.base.exceptions.exception_handler",
}
...
SITE_NAME = env("SITE_NAME", default="openhouce")
...
FRONTEND_SITE_NAME = env("FRONTEND_SITE_NAME", default="openhouce")
...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="openhouce <support@openhouce.com>"
)
EMAIL_SUBJECT_PREFIX = env("EMAIL_SUBJECT_PREFIX", default="[openhouce] ")
...
DATABASES = {
    "default": env.db("DATABASE_URL", default="postgres://localhost/openhouce")
}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                "openhouce.base.context_processors.site_settings",
...
CSRF_FAILURE_VIEW = "openhouce.base.views.csrf_failure"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "openhouce": {"handlers": ["console"], "level": "INFO", "propagate": False},
